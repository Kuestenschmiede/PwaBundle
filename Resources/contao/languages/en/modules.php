...
$GLOBALS['TL_LANG']['FMD']['pwa'] 			= array('PWA module', 'Adds the configured pwa functionality to the application.');
$GLOBALS['TL_LANG']['FMD']['push-subscription']	= array('Push subscription', 'Provides a mechanism to subscribe to push notifications.');

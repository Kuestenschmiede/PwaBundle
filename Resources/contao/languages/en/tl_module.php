...
$GLOBALS['TL_LANG']['tl_module']['pushConfig'] = ['Push configuration', 'Select the push configuration to be used. These can be created in the backend module of the same name. This setting is mandatory in multi-domain operation.'];
...
$GLOBALS['TL_LANG']['tl_module']['editSubscriptionType'] = ['Edit subscription types.'];
$GLOBALS['TL_LANG']['tl_module']['editPushConfigurations'] = ['Edit push configuration.'];
...
$GLOBALS['TL_LANG'][$strName]['appleIcon120'] = ['(nur iOS) Icon der Größe 120x120', 'Wählen Sie ein Icon für den iOS-Homescreen aus (Maße 120x120). Das apple-touch-icon im Startpunkt der Website muss dann ausgeschaltet werden.'];
$GLOBALS['TL_LANG'][$strName]['appleIcon152'] = ['(nur iOS) Icon der Größe 152x152', 'Wählen Sie ein Icon für den iOS-Homescreen aus (Maße 152x152). Das apple-touch-icon im Startpunkt der Website muss dann ausgeschaltet werden.'];
$GLOBALS['TL_LANG'][$strName]['appleIcon180'] = ['(nur iOS) Icon der Größe 180x180', 'Wählen Sie ein Icon für den iOS-Homescreen aus (Maße 180x180). Das apple-touch-icon im Startpunkt der Website muss dann ausgeschaltet werden.'];
$GLOBALS['TL_LANG'][$strName]['appleIcon167'] = ['(nur iOS) Icon der Größe 167x167', 'Wählen Sie ein Icon für den iOS-Homescreen aus (Maße 167x167). Das apple-touch-icon im Startpunkt der Website muss dann ausgeschaltet werden.'];

...
$GLOBALS['TL_LANG'][$strName]['membersOnly'] = ['Nur für Mitglieder', 'Setzen Sie diese Checkbox, wenn dieser Abonnement-Typ nur für eingeloggte Mitglieder zur Verfügung stehen soll.'];

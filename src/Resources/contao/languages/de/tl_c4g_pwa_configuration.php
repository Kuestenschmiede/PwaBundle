...
$GLOBALS['TL_LANG'][$strName]['offlinePage'] = ['Offline-Seite', 'Wählen Sie die Seite aus, die als Fallback im Offline-Modus angezeigt werden soll. Um alle Seiten zu cachen, muss der Startpunkt der Website ausgewählt werden.'];
...
$GLOBALS['TL_LANG'][$strName]['splashIphoneSecond'] = ['Icon für Splashscreen (Größe 750x1294)', 'Wählen Sie ein Icon aus, welches auf iOS für den Splash-Screen der App verwendet wird.'];
$GLOBALS['TL_LANG'][$strName]['splashIphoneThird'] = ['Icon für Splashscreen (Größe 1242x2148)', 'Wählen Sie ein Icon aus, welches auf iOS für den Splash-Screen der App verwendet wird.'];
...
$GLOBALS['TL_LANG'][$strName]['infotext'] = 'Die PWA Konfiguration wird zur Speicherug der Manifest-Datei und des Service Workers benötigt. '.
    'Bitte beachten Sie, dass die Änderungen an der Konfiguration erst mit dem erneuten Speichern des Startpunktes der Website, dem die Konfiguration zugeordnet ist, wirksam werden. '.
    'Mehr auf <a href="https://docs.con4gis.org/pwa-konfiguration" title="con4gis Docs PWA Konfiguration" target="_blank" rel="noopener"><b>docs.con4gis.org</b></a>';
